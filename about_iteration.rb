...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes a starting value the loops through the array.
    # The "sum", "product","else" become accumulators that are modified by
    # the action described after the |stuff|.
  end
